...
#
# 依赖系统 Qt 6.7+、fcitx5-qt6，不捆绑 Qt / fcitx5-qt / QML runtime。
...
URL:            https://github.com/Xiwei753/sujian
...
# 运行时依赖：系统 Qt 6.7+ 运行库 + fcitx5 输入法 Qt6 模块
...
本包不捆绑 Qt、fcitx5-qt 或 QML runtime，这些由系统包管理器通过依赖解决。
...
- Linux Qt 6.7+ 前端，依赖系统 Qt / fcitx5-qt6，不捆绑运行时
