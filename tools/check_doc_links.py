...
WHITELIST_FILENAMES = {
    ...
    'SyncController.qml', 'schema.rs', 'chapter_store.rs', 'analyzer.rs', 'ai_development_guide.md', 'ai_tool_calling.md', 'product_design_contract.md', 'desktop_ui_visual_system.md', 'settings_design.md', 'settings.json', 'bridge_contract.md', 'desktop_backend_contract.md', 'desktop_qml_ui_contract.md'
}
