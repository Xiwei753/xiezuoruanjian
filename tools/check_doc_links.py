...
WHITELIST_FILENAMES = {
    ...
    'SyncController.qml', 'schema.rs', 'chapter_store.rs', 'analyzer.rs', 'ai_development_guide.md', 'ai_tool_calling.md', 'sujian_editor_item.rs', 'settings.json', 'product_design_contract.md', 'desktop_ui_visual_system.md', 'settings_design.md', 'bridge_contract.md', 'desktop_backend_contract.md', 'desktop_qml_ui_contract.md'
}

WHITELIST_PATHS = {
    'apps/android/NativeCoreBridge',
    'bindings/android', 'docs/ai_development_guide.md', 'docs/ai_tool_calling.md', 'apps/desktop/src/sujian_editor_item.rs', 'apps/android/TECHNICAL_ROUTE.md', 'apps/desktop/TECHNICAL_ROUTE.md', 'core/writer_core/TECHNICAL_ROUTE.md', 'docs/product_design_contract.md', 'docs/desktop_ui_visual_system.md', 'docs/settings_design.md', 'docs/bridge_contract.md', 'docs/desktop_backend_contract.md', 'docs/desktop_qml_ui_contract.md',
}
