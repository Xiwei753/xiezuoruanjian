...
Supersedes: legacy technical routes
...
- **Android 技术路线**：legacy android technical route
- **Linux 技术路线**：legacy desktop technical route
- **Rust Core 技术路线**：legacy core technical route
