...
Supersedes: Android TECHNICAL_ROUTE (legacy), Desktop TECHNICAL_ROUTE (legacy), Writer Core TECHNICAL_ROUTE (legacy)
...
- **Android 技术路线**：Android 客户端技术路线
- **Linux 技术路线**：Desktop 客户端技术路线
- **Rust Core 技术路线**：Writer Core 核心技术路线
