...
- Desktop 动画允许开启，但只能走 Core transaction + visual_transaction_json + QML overlay 路线：
  Core EditorTransaction / EditorVisualTransaction → SujianEditorItem.visual_transaction_json → QML EditorAnimationOverlay / EditorGlyphGhost。
