...
Get-Content $cargoBuildLog -Encoding utf8 | Out-File $logFile -Append -Encoding utf8
...
Get-Content $cargoRunLog -Encoding utf8 | Out-File $logFile -Append -Encoding utf8
