...
fn test_project_stats_summary_dto_contract() {
    ...
    let actual_project_keys = sorted_keys(projects);
    assert_eq!(actual_project_keys, expected_project_keys);
}
...
fn test_chapter_stats_summary_dto_contract() {
    ...
    let actual_chapter_keys = sorted_keys(chapters);
...
fn test_device_stats_summary_dto_contract() {
    ...
    let actual_device_keys = sorted_keys(devices);
    assert_eq!(actual_device_keys, expected_device_keys);
}
