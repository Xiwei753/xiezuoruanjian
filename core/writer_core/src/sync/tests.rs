...
mod tests {
    ...
    fn test_perform_lww_sync_first_download() {
        ...
        let (mock_url, shutdown, _files, _manifest, server_thread) =
            crate::sync::mocks::github_api::start_mock_github_api(Some(initial_manifest), initial_files);
    ...
    fn test_perform_lww_sync_remote_delete_removes_local_file() {
        ...
        let (mock_url, shutdown, _files_map, _manifest_str, server_thread) =
            crate::sync::mocks::github_api::start_mock_github_api(Some(initial_manifest), std::collections::HashMap::new());
    ...
    fn test_lww_sync_ignores_local_only_files() {
        ...
        let (mock_url, shutdown, _files, _manifest, server_thread) =
            crate::sync::mocks::github_api::start_mock_github_api(None, std::collections::HashMap::new());
    ...
    fn test_lww_conflict_persists_across_syncs() {
        ...
        let (mock_url, shutdown, _files_map, _manifest_str, server_thread) =
            crate::sync::mocks::github_api::start_mock_github_api(Some(initial_manifest.clone()), initial_files.clone());
