...
pub struct SyncConfig {
    ...
    /// Android sets this based on INTERNET permission; Linux and Windows clients always true.
    ...
    /// Android sets this based on ACCESS_NETWORK_STATE permission; Linux and Windows clients always true.
