...
/// 第1项：composition preedit cursor 现在用 `Utf16CodeUnitOffset` 强类型，
...
/// 第1项：中文 "你" UTF-16 len=1，cursor=3 越界 → InvalidOffset。
#[test]
...
/// 第1项：emoji "👨‍👩‍👧"（ZWJ 序列）UTF-16 len=8，cursor=4 合法。
#[test]
...
/// 第4项：所有 Core 命令统一 composition 回填出口。
...
/// 第4项：text-modifying 命令（insert/delete/undo/redo/commitText/
...
/// 第4项：cancel_composition 成功后 DTO composition 保持 None。
#[test]
