...
impl WriterCoreApi {
    ...
    ///
    /// 第2点：通用 full-sync 入口不再 `#[cfg(feature = "github-api")]`
    ...
    pub fn perform_full_sync(
        ...
        //
        // 第2点：staging 不再按 active_provider 分 Git/GithubApi
