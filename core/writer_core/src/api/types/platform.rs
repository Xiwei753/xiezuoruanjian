...
// ── Workbench DTOs (Issue #568) ──

#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, PartialEq, Default)]
pub enum WorkbenchPanelIdDto {
    #[default]
    ProjectNavigator,
    ChapterNavigator,
    AiAssistant,
...
impl From<crate::layout_policy::WorkbenchPanelId> for WorkbenchPanelIdDto {
    fn from(id: crate::layout_policy::WorkbenchPanelId) -> Self {
        match id {
            crate::layout_policy::WorkbenchPanelId::ProjectNavigator => Self::ProjectNavigator,
            crate::layout_policy::WorkbenchPanelId::ChapterNavigator => Self::ChapterNavigator,
            crate::layout_policy::WorkbenchPanelId::AiAssistant => Self::AiAssistant,
            crate::layout_policy::WorkbenchPanelId::Search => Self::Search,
            crate::layout_policy::WorkbenchPanelId::Statistics => Self::Statistics,
            crate::layout_policy::WorkbenchPanelId::StarMap => Self::StarMap,
            crate::layout_policy::WorkbenchPanelId::DocumentOutline => Self::DocumentOutline,
            crate::layout_policy::WorkbenchPanelId::CharacterInfo => Self::CharacterInfo,
        }
    }
}

impl From<WorkbenchPanelIdDto> for crate::layout_policy::WorkbenchPanelId {
    fn from(dto: WorkbenchPanelIdDto) -> Self {
        match dto {
            WorkbenchPanelIdDto::ProjectNavigator => Self::ProjectNavigator,
            WorkbenchPanelIdDto::ChapterNavigator => Self::ChapterNavigator,
            WorkbenchPanelIdDto::AiAssistant => Self::AiAssistant,
            WorkbenchPanelIdDto::Search => Self::Search,
            WorkbenchPanelIdDto::Statistics => Self::Statistics,
            WorkbenchPanelIdDto::StarMap => Self::StarMap,
            WorkbenchPanelIdDto::DocumentOutline => Self::DocumentOutline,
            WorkbenchPanelIdDto::CharacterInfo => Self::CharacterInfo,
        }
    }
}

#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, PartialEq, Default)]
pub enum DockZoneDto {
    #[default]
    Left,
    Right,
    Bottom,
...
impl From<crate::layout_policy::DockZone> for DockZoneDto {
    fn from(z: crate::layout_policy::DockZone) -> Self {
        match z {
            crate::layout_policy::DockZone::Left => Self::Left,
            crate::layout_policy::DockZone::Right => Self::Right,
            crate::layout_policy::DockZone::Bottom => Self::Bottom,
            crate::layout_policy::DockZone::Floating => Self::Floating,
        }
    }
}

impl From<DockZoneDto> for crate::layout_policy::DockZone {
    fn from(dto: DockZoneDto) -> Self {
        match dto {
            DockZoneDto::Left => Self::Left,
            DockZoneDto::Right => Self::Right,
            DockZoneDto::Bottom => Self::Bottom,
            DockZoneDto::Floating => Self::Floating,
        }
    }
}

#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, PartialEq, Default)]
pub enum PanelVisibilityDto {
    #[default]
    Hidden,
    Collapsed,
    Expanded,
...
impl From<crate::layout_policy::PanelVisibility> for PanelVisibilityDto {
    fn from(v: crate::layout_policy::PanelVisibility) -> Self {
        match v {
            crate::layout_policy::PanelVisibility::Hidden => Self::Hidden,
            crate::layout_policy::PanelVisibility::Collapsed => Self::Collapsed,
            crate::layout_policy::PanelVisibility::Expanded => Self::Expanded,
        }
    }
}

impl From<PanelVisibilityDto> for crate::layout_policy::PanelVisibility {
    fn from(dto: PanelVisibilityDto) -> Self {
        match dto {
            PanelVisibilityDto::Hidden => Self::Hidden,
            PanelVisibilityDto::Collapsed => Self::Collapsed,
            PanelVisibilityDto::Expanded => Self::Expanded,
        }
    }
}

#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, PartialEq, Default)]
pub enum WorkbenchPresetDto {
    #[default]
    FocusWriting,
    ChapterWriting,
    AiWriting,
...
impl From<crate::layout_policy::WorkbenchPreset> for WorkbenchPresetDto {
    fn from(p: crate::layout_policy::WorkbenchPreset) -> Self {
        match p {
            crate::layout_policy::WorkbenchPreset::FocusWriting => Self::FocusWriting,
            crate::layout_policy::WorkbenchPreset::ChapterWriting => Self::ChapterWriting,
            crate::layout_policy::WorkbenchPreset::AiWriting => Self::AiWriting,
            crate::layout_policy::WorkbenchPreset::ResearchWriting => Self::ResearchWriting,
            crate::layout_policy::WorkbenchPreset::Custom => Self::Custom,
        }
    }
}

impl From<WorkbenchPresetDto> for crate::layout_policy::WorkbenchPreset {
    fn from(dto: WorkbenchPresetDto) -> Self {
        match dto {
            WorkbenchPresetDto::FocusWriting => Self::FocusWriting,
            WorkbenchPresetDto::ChapterWriting => Self::ChapterWriting,
            WorkbenchPresetDto::AiWriting => Self::AiWriting,
            WorkbenchPresetDto::ResearchWriting => Self::ResearchWriting,
            WorkbenchPresetDto::Custom => Self::Custom,
        }
    }
}
...
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, PartialEq)]
#[serde(rename_all = "camelCase")]
pub struct WorkbenchPanelStateDto {
    pub id: WorkbenchPanelIdDto,
    pub zone: DockZoneDto,
    pub visibility: PanelVisibilityDto,
    pub size_dp: f32,
...
impl From<crate::layout_policy::WorkbenchPanelState> for WorkbenchPanelStateDto {
    fn from(p: crate::layout_policy::WorkbenchPanelState) -> Self {
        Self {
            id: p.id.into(),
            zone: p.zone.into(),
            ...
            order: p.order,
            floating_x: p.floating_x,
            floating_y: p.floating_y,
            floating_width_dp: p.floating_width_dp,
            floating_height_dp: p.floating_height_dp,
        }
    }
}

impl From<WorkbenchPanelStateDto> for crate::layout_policy::WorkbenchPanelState {
    fn from(dto: WorkbenchPanelStateDto) -> Self {
        Self {
            id: dto.id.into(),
            zone: dto.zone.into(),
            visibility: dto.visibility.into(),
            size_dp: dto.size_dp,
            tab_group_id: dto.tab_group_id,
            order: dto.order,
            floating_x: dto.floating_x,
            floating_y: dto.floating_y,
            floating_width_dp: dto.floating_width_dp,
            floating_height_dp: dto.floating_height_dp,
        }
    }
}
...
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, PartialEq)]
#[serde(rename_all = "camelCase")]
pub struct TabGroupActiveDto {
    pub group_id: String,
    pub active_panel: WorkbenchPanelIdDto,
}

impl From<(String, crate::layout_policy::WorkbenchPanelId)> for TabGroupActiveDto {
    fn from((group_id, active_panel): (String, crate::layout_policy::WorkbenchPanelId)) -> Self {
        Self {
            group_id,
...
impl From<TabGroupActiveDto> for (String, crate::layout_policy::WorkbenchPanelId) {
    fn from(dto: TabGroupActiveDto) -> Self {
        (dto.group_id, dto.active_panel.into())
    }
}

#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, PartialEq)]
#[serde(rename_all = "camelCase")]
pub struct WorkbenchLayoutStateDto {
    pub panels: Vec<WorkbenchPanelStateDto>,
    pub active_tab_by_group: Vec<TabGroupActiveDto>,
    pub preset: WorkbenchPresetDto,
}

impl From<crate::layout_policy::WorkbenchLayoutState> for WorkbenchLayoutStateDto {
    fn from(s: crate::layout_policy::WorkbenchLayoutState) -> Self {
        Self {
            panels: s.panels.into_iter().map(Into::into).collect(),
            active_tab_by_group: s.active_tab_by_group.into_iter().map(Into::into).collect(),
            preset: s.preset.into(),
        }
    }
}

impl From<WorkbenchLayoutStateDto> for crate::layout_policy::WorkbenchLayoutState {
    fn from(dto: WorkbenchLayoutStateDto) -> Self {
        Self {
            panels: dto.panels.into_iter().map(Into::into).collect(),
            active_tab_by_group: dto.active_tab_by_group.into_iter().map(Into::into).collect(),
            preset: dto.preset.into(),
        }
    }
}
...
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, PartialEq)]
#[serde(rename_all = "camelCase")]
pub struct WorkbenchConstraintsDto {
...
impl From<crate::layout_policy::WorkbenchConstraints> for WorkbenchConstraintsDto {
    fn from(c: crate::layout_policy::WorkbenchConstraints) -> Self {
        Self {
            side_panel_min_dp: c.side_panel_min_dp,
            side_panel_max_dp: c.side_panel_max_dp,
            bottom_panel_min_dp: c.bottom_panel_min_dp,
            bottom_panel_max_ratio: c.bottom_panel_max_ratio,
            editor_min_dp: c.editor_min_dp,
            allow_side_dock: c.allow_side_dock,
            allow_both_side_docks: c.allow_both_side_docks,
            allow_bottom_dock: c.allow_bottom_dock,
        }
    }
}

impl From<WorkbenchConstraintsDto> for crate::layout_policy::WorkbenchConstraints {
    fn from(dto: WorkbenchConstraintsDto) -> Self {
        Self {
            side_panel_min_dp: dto.side_panel_min_dp,
            side_panel_max_dp: dto.side_panel_max_dp,
            bottom_panel_min_dp: dto.bottom_panel_min_dp,
            bottom_panel_max_ratio: dto.bottom_panel_max_ratio,
            editor_min_dp: dto.editor_min_dp,
            allow_side_dock: dto.allow_side_dock,
            allow_both_side_docks: dto.allow_both_side_docks,
            allow_bottom_dock: dto.allow_bottom_dock,
        }
    }
}

#[cfg(test)]
mod workbench_dto_tests {
    use super::*;
    use crate::layout_policy;

    fn roundtrip_panel_id(id: layout_policy::WorkbenchPanelId) {
        let dto: WorkbenchPanelIdDto = id.into();
        let back: layout_policy::WorkbenchPanelId = dto.into();
        assert_eq!(id, back);
    }

    #[test]
    fn test_workbench_panel_id_roundtrip() {
        roundtrip_panel_id(layout_policy::WorkbenchPanelId::ProjectNavigator);
        roundtrip_panel_id(layout_policy::WorkbenchPanelId::ChapterNavigator);
        roundtrip_panel_id(layout_policy::WorkbenchPanelId::AiAssistant);
        roundtrip_panel_id(layout_policy::WorkbenchPanelId::Search);
        roundtrip_panel_id(layout_policy::WorkbenchPanelId::Statistics);
        roundtrip_panel_id(layout_policy::WorkbenchPanelId::StarMap);
        roundtrip_panel_id(layout_policy::WorkbenchPanelId::DocumentOutline);
        roundtrip_panel_id(layout_policy::WorkbenchPanelId::CharacterInfo);
    }

    #[test]
    fn test_dock_zone_roundtrip() {
        for zone in &[layout_policy::DockZone::Left, layout_policy::DockZone::Right, layout_policy::DockZone::Bottom, layout_policy::DockZone::Floating] {
            let dto: DockZoneDto = (*zone).into();
            let back: layout_policy::DockZone = dto.into();
            assert_eq!(*zone, back);
        }
    }

    #[test]
    fn test_panel_visibility_roundtrip() {
        for vis in &[layout_policy::PanelVisibility::Hidden, layout_policy::PanelVisibility::Collapsed, layout_policy::PanelVisibility::Expanded] {
            let dto: PanelVisibilityDto = (*vis).into();
            let back: layout_policy::PanelVisibility = dto.into();
            assert_eq!(*vis, back);
        }
    }

    #[test]
    fn test_workbench_preset_roundtrip() {
        for preset in &[layout_policy::WorkbenchPreset::FocusWriting, layout_policy::WorkbenchPreset::ChapterWriting, layout_policy::WorkbenchPreset::AiWriting, layout_policy::WorkbenchPreset::ResearchWriting, layout_policy::WorkbenchPreset::Custom] {
            let dto: WorkbenchPresetDto = (*preset).into();
            let back: layout_policy::WorkbenchPreset = dto.into();
            assert_eq!(*preset, back);
        }
    }

    #[test]
    fn test_workbench_layout_state_roundtrip() {
        let state = layout_policy::preset_workbench_layout(layout_policy::WorkbenchPreset::ChapterWriting);
        let dto: WorkbenchLayoutStateDto = state.clone().into();
        let back: layout_policy::WorkbenchLayoutState = dto.into();
        assert_eq!(state.preset, back.preset);
        assert_eq!(state.panels.len(), back.panels.len());
    }

    #[test]
    fn test_workbench_constraints_roundtrip() {
        let metrics = layout_policy::WindowMetrics::default();
        let constraints = layout_policy::resolve_workbench_constraints(&metrics);
        let dto: WorkbenchConstraintsDto = constraints.clone().into();
        let back: layout_policy::WorkbenchConstraints = dto.into();
        assert!((back.side_panel_min_dp - constraints.side_panel_min_dp).abs() < f32::EPSILON);
        assert_eq!(back.allow_side_dock, constraints.allow_side_dock);
    }

    #[test]
    fn test_workbench_layout_state_camelcase_serialization() {
        let state = layout_policy::default_workbench_layout();
        let dto: WorkbenchLayoutStateDto = state.into();
        let json = serde_json::to_string(&dto).unwrap();
        assert!(json.contains("tabGroupId"));
        assert!(json.contains("floatingX"));
        assert!(json.contains("floatingWidthDp"));
    }
}
