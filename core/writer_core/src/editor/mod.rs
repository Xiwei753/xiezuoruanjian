...
pub use transaction::{
    ...
    compute_animation_units, compute_rebase, compute_rebase_slice_mappings,
    ...
    CaretAffinity, ClusterRect, ClusterRun, CompositionOperationKind, CompositionSession,
    ...
    PreeditVisualTransaction, RebaseContinuation, RebaseFrameSnapshot, RebaseReason,
    RebaseSliceMapping, Rect, ReflowGlyphRect, SliceMatchInput, SnapshotOwner, StaticLinePatch,
    Timeline, TransactionCancelReason, TransactionRebase, UnifiedTransactionKind, VisualClassKind,
