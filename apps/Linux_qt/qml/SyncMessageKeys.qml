...
QtObject {
    ...
    property string _error_invalid_workspace: qsTr("error.invalid_workspace")
    ...
    property string _error_refuse_delete_workspace_root: qsTr("error.refuse_delete_workspace_root")
