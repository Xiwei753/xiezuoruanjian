...
impl StarMapBackend {
    ...
    fn create_starmap(
        ...
        }).unwrap_or_else(|_| crate::backend::json_utils::qjson_object_from_json(&crate::backend::json_utils::borrow_conflict_error_json()))
    }
...
impl AppBackend {
    ...
    pub(crate) fn create_starmap_node(
        &mut self,
        starmap_id: QString,
        title: QString,
        kind: QString,
    ...
    pub(crate) fn create_starmap_edge(
        &mut self,
        starmap_id: QString,
        from_node_id: QString,
        to_node_id: QString,
