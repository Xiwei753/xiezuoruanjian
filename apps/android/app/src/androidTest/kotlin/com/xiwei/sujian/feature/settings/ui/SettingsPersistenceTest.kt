...
class SettingsPersistenceTest {
    ...
    fun typingAnimationToggle_persistsAfterColdRestart() {
        ...
        val wasOn =
            toggleSemantics.config.getOrElseNullable(
        ...
        ComposeWait.waitUntil(composeTestRule, {
            ...
            val state =
                node.fetchSemanticsNode().config.getOrElseNullable(
                    androidx.compose.ui.semantics.SemanticsProperties.ToggleableState,
                ) { null }
            if (wasOn) {
                state == androidx.compose.ui.state.ToggleableState.Off
            } else {
        ...
        ComposeWait.waitUntil(composeTestRule, {
            ...
            "Settings repository did not reflect typing animation change to $expectedEnabled"
        })
    ...
    fun fontSizeSlider_persistsAfterColdRestart() {
        ...
        val restoredStateDesc =
            restoredSliderNode.fetchSemanticsNode().config[
