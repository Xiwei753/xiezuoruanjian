...
class WorkspaceBridge(val appService: AppServiceBridge) {
    ...
    fun createVolume(
        projectId: String,
        title: String,
    ): BridgeResult<Volume> = appService.createVolume(projectId, title)
