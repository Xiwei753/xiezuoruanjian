...
internal fun com.xiwei.sujian.data.SyncProfileReadResult.toSyncProfileLoadState(): SyncProfileLoadState = when (this) {
...
val syncSecrets: SettingsSaveCommand.SyncSecrets? = null,
    ...
    fun isEmpty(): Boolean =
        local == null && fontSize == null && syncConfig == null && syncSecrets == null
}
