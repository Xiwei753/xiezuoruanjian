...
fun EditorSessionCoordinator.isVersionOlder(committed: DocumentVersion, incoming: DocumentVersion): Boolean {
...
fun EditorSessionCoordinator.isComparable(committed: DocumentVersion, incoming: DocumentVersion): Boolean {
...
fun EditorSessionCoordinator.markSaved(targetId: String, savedVersion: DocumentVersion) {
