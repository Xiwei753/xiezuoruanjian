...
object ThemeDtoMapper {
    ...
    fun fromDto(dto: uniffi.writer_core.ThemeColorSchemeDto): ThemeColorScheme = ThemeColorScheme(
        primary = dto.primary,
    ...
    fun fromDto(dto: uniffi.writer_core.BuiltinThemeDto): BuiltinTheme = BuiltinTheme(
        themeId = dto.themeId,
        name = dto.name,
    ...
    fun fromDto(dto: uniffi.writer_core.ThemePaletteRecordDto): ThemePaletteRecord = ThemePaletteRecord(
