...
internal fun StarMapAnchorDto.toAnchorModel(): StarMapAnchorData = StarMapAnchorData(
    anchorId = anchorId,
...
internal fun StarMapPortalDto.toPortalModel(): StarMapPortalData = StarMapPortalData(
...
internal fun StarMapDisplayPolicyDto.toDisplayPolicyModel(): StarMapDisplayPolicyData = StarMapDisplayPolicyData(
...
internal fun StarMapProvenanceDto.toProvenanceModel(): StarMapProvenanceData = StarMapProvenanceData(
    source = source.name,
    sourceId = sourceId,
...
internal fun StarMapGraphNode.toDto(base: StarMapNodeDto?): StarMapNodeDto {
    ...
    val dtoProvenance = provenance?.provenanceToDto() ?: base?.provenance ?: StarMapProvenanceDto(
...
internal fun StarMapGraphNode.contentToDto(): StarMapNodeContentDto = StarMapNodeContentDto(
...
internal fun StarMapAnchorData.anchorToDto(): StarMapAnchorDto = StarMapAnchorDto(
    anchorId = anchorId,
...
internal fun StarMapPortalData.portalToDto(): StarMapPortalDto = StarMapPortalDto(
    targetStarmapId = targetStarmapId,
    ...
    previewPolicy = when (previewPolicy) {
...
internal fun StarMapDisplayPolicyData.displayPolicyToDto(): StarMapDisplayPolicyDto = StarMapDisplayPolicyDto(
    importance = importance,
    minVisibleScale = minVisibleScale,
    titleScale = titleScale,
    summaryScale = summaryScale,
...
internal fun StarMapProvenanceData.provenanceToDto(): StarMapProvenanceDto = StarMapProvenanceDto(
    source = when (source) {
    ...
    generatedBy = generatedBy,
    promptId = promptId,
    reviewStatus = when (reviewStatus) {
...
internal fun String.toOpenBehaviorDto(): StarMapOpenBehaviorDto = when (this) {
...
internal fun StarMapDeepTargetData.toDeepTargetDto(): StarMapDeepTargetDto = StarMapDeepTargetDto(
    starmapId = starmapId,
    path = path.map { it.toPathSegmentDto() },
    target = target.toTargetDetailDto()
)

internal fun StarMapPathSegmentData.toPathSegmentDto(): StarMapPathSegmentDto = StarMapPathSegmentDto(
    kind = kind,
    starmapId = starmapId
)

internal fun StarMapTargetDetailData.toTargetDetailDto(): StarMapTargetDetailDto = StarMapTargetDetailDto(
    kind = kind,
    nodeId = nodeId,
    anchorId = anchorId,
    projectId = projectId,
