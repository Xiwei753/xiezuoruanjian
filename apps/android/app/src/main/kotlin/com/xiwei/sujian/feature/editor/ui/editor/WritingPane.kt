...
import com.xiwei.sujian.feature.editor.SaveStatus
import com.xiwei.sujian.feature.editor.applyExternalContentToUi
import com.xiwei.sujian.feature.editor.compose.LocalEditorWindowHost
import com.xiwei.sujian.feature.editor.confirmEditorAttached
import com.xiwei.sujian.feature.editor.isCurrentChapter
import com.xiwei.sujian.feature.editor.notifySyncMergeConflict
import com.xiwei.sujian.feature.editor.onContentChanged
import com.xiwei.sujian.feature.editor.reloadSettings
import com.xiwei.sujian.feature.editor.session.EditableTextTarget
...
private data class EditorAttachInputs(
    val uiState: com.xiwei.sujian.feature.editor.EditorUiState,
...
private fun WritingPaneSettingsReload(
    ...
    LaunchedEffect(targetId) {
        com.xiwei.sujian.core.interop.settings.CoreSettingsEvents.editorSettingsChanged.collect {
            viewModel.reloadSettings()
        }
    }
}
        ...
        if (!sameChapter) {
            if (currentViewModel.isCurrentChapter(chapter.projectId, chapter.volumeId, chapter.chapterId)) {
                ...
                when (
                    ...
                    is com.xiwei.sujian.feature.editor.ChapterSwitchResult.Success -> {
                        // #595 一：只有保存+加载+session 预准备都成功，旧章节才
                        // 由事务提交（commitPreparedSession 保留其持久 session）；
                        // 窗口解绑由 DisposableEffect onDispose 完成。
                        failedSwitchTarget = null
                    }
                    is com.xiwei.sujian.feature.editor.ChapterSwitchResult.SaveFailed,
                    is com.xiwei.sujian.feature.editor.ChapterSwitchResult.LoadFailed,
                    -> {
                    ...
                    com.xiwei.sujian.feature.editor.ChapterSwitchResult.Stale -> {
...
private fun WritingPaneExternalContentFlow(
    ...
    coordinator: com.xiwei.sujian.feature.editor.session.EditorWindowHost,
    targetId: String,
    currentUiState: com.xiwei.sujian.feature.editor.EditorUiState,
...
private fun WritingPaneColumn(
    modifier: Modifier,
    chapterTitle: String,
    uiState: com.xiwei.sujian.feature.editor.EditorUiState,
    showEditor: Boolean,
    coordinator: com.xiwei.sujian.feature.editor.session.EditorWindowHost,
    targetId: String,
) {
    ...
    Column(modifier = modifier.fillMaxSize()) {
        ...
        if (!showEditor) {
            ...
            com.xiwei.sujian.feature.editor.compose.WritingEditorSurface(
                coordinator = coordinator,
                targetId = targetId,
