...
internal fun com.xiwei.sujian.data.SyncDryRunOutcome.toAppIoResult(): SyncCommandIoResult =
    when (this) {
...
internal fun com.xiwei.sujian.data.SyncDiagnosticsOutcome.toAppIoResult(): SyncCommandIoResult =
    when (this) {
