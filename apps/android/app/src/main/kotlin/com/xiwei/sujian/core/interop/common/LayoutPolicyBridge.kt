...
import com.xiwei.sujian.core.model.AvoidRegion
import com.xiwei.sujian.core.model.EditorMode
...
import com.xiwei.sujian.core.model.HeightClass
import com.xiwei.sujian.core.model.LayoutPlan
import com.xiwei.sujian.core.model.NavigationMode
import com.xiwei.sujian.core.model.NavigationPresentation
import com.xiwei.sujian.core.model.Orientation
import com.xiwei.sujian.core.model.PaneWidthConstraint
import com.xiwei.sujian.core.model.PointerKind
import com.xiwei.sujian.core.model.ShellMode
import com.xiwei.sujian.core.model.VisiblePaneRoles
import com.xiwei.sujian.core.model.WidthClass
...
import uniffi.writer_core.FoldFeatureInfoDto
import uniffi.writer_core.FoldOcclusionDto
import uniffi.writer_core.FoldOrientationDto
import uniffi.writer_core.FoldStateDto
import uniffi.writer_core.HeightClassDto
import uniffi.writer_core.LayoutPlanDto
import uniffi.writer_core.NavigationModeDto
import uniffi.writer_core.NavigationPresentationDto
import uniffi.writer_core.OrientationDto
import uniffi.writer_core.PaneWidthConstraintDto
...
import uniffi.writer_core.VisiblePaneRolesDto
import uniffi.writer_core.WidthClassDto
import uniffi.writer_core.WindowMetricsDto
...
class LayoutPolicyBridge internal constructor(private val holder: WriterAppServiceHolder) {
    ...
    fun resolveLayout(metrics: WindowMetricsDto): BridgeResult<LayoutPlanDto> =
        holder.wrapResult {
    ...
    private fun FoldFeatureInfo.toDto(): FoldFeatureInfoDto =
        FoldFeatureInfoDto(
            state = state.toDto(),
    ...
    private fun FoldState.toDto(): FoldStateDto =
        when (this) {
    ...
    private fun PointerKind.toDto(): PointerKindDto =
        when (this) {
    ...
    private fun WidthClassDto.toModel(): WidthClass =
        when (this) {
    ...
    private fun HeightClassDto.toModel(): HeightClass =
        when (this) {
    ...
    private fun ShellModeDto.toModel(): ShellMode =
        when (this) {
    ...
    private fun WorkspacePaneModeDto.toModel(): WorkspacePaneMode =
        when (this) {
    ...
    private fun VisiblePaneRolesDto.toModel(): VisiblePaneRoles =
        VisiblePaneRoles(
    ...
    private fun PaneWidthConstraintDto.toModel(): PaneWidthConstraint =
        PaneWidthConstraint(
            minDp = minDp,
    ...
    private fun AvoidRegionDto.toModel(): AvoidRegion =
        AvoidRegion(
            leftDp = leftDp,
            topDp = topDp,
            rightDp = rightDp,
    ...
    private fun LayoutPlanDto.toModel(): LayoutPlan =
        LayoutPlan(
