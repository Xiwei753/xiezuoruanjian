 ...
 * - coordinated=true：完整模式，统一用 [textDurationMillis] 作为这一笔 [CoordinatedEditMotion] 的时长；
 ...
 *   但编辑器仍正常工作。优先级最高。
 *
 * Issue #728 评论 5754045689：重新由 [CoordinatedEditMotion] 统一画 caret —
 ...
 *
 * Issue #737：[CoordinatedEditMotion] 取代旧 [ComposeEditMotion]（已删除），
...
data class EditorMotionPolicy(
     ...
     *   统一用 [textDurationMillis] 作为这一笔 [CoordinatedEditMotion] 的时长；
     *   独立的 [textEnabled]/[cursorEnabled]/[cursorDurationMillis] 只在 coordinated=false 时生效。
