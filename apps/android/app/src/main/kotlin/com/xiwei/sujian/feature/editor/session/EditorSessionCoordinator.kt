...
open class EditorSessionCoordinator(
    ...
    fun executeTargetCommand(
        ...
        val editResult = com.xiwei.sujian.feature.editor.projection.EditResult.fromDto(dtoResult)
        ...
        return when (
            ...
            is BridgeResult.Success -> {
                ...
                if (id == null || id == 0UL) {
                    ...
                    com.xiwei.sujian.core.interop.diagnostics.DiagnosticsEventsInterop.sessionLifecycle(id.toString(), "create")
                    id
                }
            }
            else -> {
