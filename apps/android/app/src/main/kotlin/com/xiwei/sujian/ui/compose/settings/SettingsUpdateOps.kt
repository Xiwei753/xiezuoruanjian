...
internal fun SettingsViewModel.updateProjectSyncConfig(config: com.xiwei.sujian.model.SyncConfig) {
...
internal fun SettingsViewModel.updateProjectSyncSecrets(secrets: com.xiwei.sujian.model.SyncSecrets) {
...
internal fun SettingsViewModel.updateAppSyncConfig(config: com.xiwei.sujian.model.SyncConfig) {
...
internal fun SettingsViewModel.updateAppSyncSecrets(secrets: com.xiwei.sujian.model.SyncSecrets) {
...
): Pair<SyncProfileLoadState, com.xiwei.sujian.model.SyncCapabilityData> {
