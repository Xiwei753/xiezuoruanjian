...
class SyncProfileGateOrderTest {
    @Test
    fun snapshotRead_waitsForCommitInProgress_andCompletesAfterRelease() =
        runTest {
    ...
    @Test
    fun commit_waitsForSnapshotReadInProgress_andCompletesAfterRelease() =
        runTest {
    ...
    @Test
    fun consecutiveCommitAndRead_doNotLeaveLockHeld() =
        runTest {
