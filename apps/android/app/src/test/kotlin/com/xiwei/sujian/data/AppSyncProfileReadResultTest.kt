...
class AppSyncProfileReadResultTest {
    ...
    fun appSyncProfileSnapshot_carriesGenerationConfigSecrets() {
        val snapshot =
            AppSyncProfileSnapshot(
                ...
                secrets = com.xiwei.sujian.model.SyncSecrets(token = "app-token"),
            )
    ...
    fun appSyncProfileReadResult_isDistinctFromProjectSyncProfileReadResult() {
        ...
        // 不共享子类型 — 避免泛型化扩散。
        val appSnapshot =
            AppSyncProfileSnapshot(1L, com.xiwei.sujian.model.SyncConfig(), com.xiwei.sujian.model.SyncSecrets())
        val projectSnapshot =
            ProjectSyncProfileSnapshot(1L, com.xiwei.sujian.model.SyncConfig(), com.xiwei.sujian.model.SyncSecrets())
