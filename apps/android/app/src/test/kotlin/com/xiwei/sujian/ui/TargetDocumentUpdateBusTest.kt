...
class TargetDocumentUpdateBusTest {
    ...
    private fun repoFact(targetId: String, version: Long, text: String = "t$version") =
        TargetDocumentFact(
            targetId = targetId,
            text = text,
    ...
    @Test
    fun newCollector_receivesLatestFactImmediately() = runTest {
    ...
    @Test
    fun facts_arePartitionedByTarget() = runTest {
        val bus = TargetDocumentUpdateBus()
    ...
    @Test
    fun multipleCollectors_allReceiveFacts() = runTest {
        val bus = TargetDocumentUpdateBus()
    ...
    @Test
    fun sameTargetSequentialFacts_conflateToLatest() = runTest {
        val bus = TargetDocumentUpdateBus()
        bus.emit(repoFact("t1", 1L))
        bus.emit(repoFact("t1", 2L))
    ...
    @Test
    fun busStoresDocumentFactNotRawCommand() = runTest {
