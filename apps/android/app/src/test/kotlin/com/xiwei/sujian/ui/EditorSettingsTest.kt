...
class EditorSettingsTest {
    ...
    fun testWriterEditTextSettingsPropagation() {
        ...
        // Default duration check — controllers are initialized in Robolectric
        ...
        // SmoothCursorRenderer clamps to [30, 1000]
        assertEquals(30L, editText.cursorAnimationDurationMs())

        // Disable typing animation setting
        // TypingAnimationController clamps duration to [30, 1000]ms, so 0L becomes 30L
        editText.setTypingAnimationEnabled(false, 0L)
        assertEquals(30L, editText.typingAnimationDurationMs())
    }
